...
public class FlowuiAccessChecker {
    ...
    @Autowired
    public FlowuiAccessChecker(AccessAnnotationChecker accessAnnotationChecker,
    ...
    public boolean isMenuPermitted(MenuItem menuItem) {
        ...
        boolean hasAccess = accessAnnotationChecker.hasAccess(controllerClass);
    ...
    public boolean isViewPermitted(Class<?> target) {
        boolean hasAccess = accessAnnotationChecker.hasAccess(target);
